...
%
% Source: https://alexbjorkholm.wordpress.com/2016/10/07/exporting-3d-objects-from-octave/
%
% Example usage for synthetic cones:
% [x, y, z] = cylinder (0.5:-0.05:0, 50); surf (x, y, z); axis equal;
% saveobjmesh( 'cone_030.obj',x,y,z )
% See: https://de.mathworks.com/help/matlab/ref/surfnorm.html
