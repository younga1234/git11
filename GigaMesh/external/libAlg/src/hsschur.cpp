    ...
    while(true)
    {
        ...
        for(its = 0; its <= itn; its++)
        {
            ...
            for(k = i; k >= l+1; k--)
            {
                ...
                if( ap::fp_less_eq(fabs(h(k,k-1)),ap::maxreal(ulp*tst1, smlnum)) )
                {
                    break;
                }
            }
                ...
                if( ap::fp_greater_eq(wi(j),0) )
                {
                    ...
                    else
                    {
                        if( ap::fp_greater(wi(j),0) )
                        {
                            ...
                            p1 = nv+1;
                            ap::vmul(&vv(1), 1, ap::vlen(1,p1), temp);
            ...
            for(k = l; k <= i-1; k++)
            {
                ...
                if( k>l )
                {
                    p1 = k-1;
                    p2 = k+nr-1;
                    ap::vmove(&v(1), 1, &h(k, p1), h.getstride(), ap::vlen(1,nr));
                }
        ...
        for(its = 0; its <= itn; its++)
        {
            ...
            else
            {
                ...
                if( ap::fp_greater(disc,0) )
                {
                    ...
                    disc = sqrt(disc);
                    ave = 0.5*(h33+h44);
                    if( ap::fp_greater(fabs(h33)-fabs(h44),0) )
                    {
                        h33 = h33*h44-h43h34;
            ...
            for(m = i-2; m >= l; m--)
            {
                ...
                if( ap::fp_less_eq(fabs(h10)*(fabs(v2)+fabs(v3)),ulp*tst1) )
                {
                    break;
                }
            }
     ...
     double& sn)
{
    ...
    else
    {
        ...
        {
            if( ap::fp_eq(a-d,0)&&extschursigntoone(b)!=extschursigntoone(c) )
            {
                cs = 1;
                sn = 0;
            }
            else
            {
                ...
                //
                if( ap::fp_greater_eq(z,multpl*eps) )
                {
